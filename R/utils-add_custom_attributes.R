...
is_enabler_2u <- function(is_enabler_3, mana_cost) {
  is_enabler_3 & grepl("{2}{U}", mana_cost, fixed = TRUE)
}

is_enabler_2b <- function(is_enabler_3, mana_cost) {
  is_enabler_3 & grepl("{2}{B}", mana_cost, fixed = TRUE)
}
