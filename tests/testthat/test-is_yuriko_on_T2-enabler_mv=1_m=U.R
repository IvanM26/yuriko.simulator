...
hand <- get_hand(testdata, c("Mothdust Changeling", "Island", "Otawara, Soaring City", "Agadeem's Awakening // Agadeem, the Undercrypt"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Swamp", "Takenuma, Abandoned Mire", "Sink into Stupor // Soporific Springs"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Island", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Swamp", "Gemstone Caverns", "Sink into Stupor // Soporific Springs"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Mutavault", "Gemstone Caverns", "Sink into Stupor // Soporific Springs", "Mox Diamond"))
test_that("enabler 1 u + 2 lands where both produce colorless and mox diamond and mdfc land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Mutavault", "Gemstone Caverns", "Sink into Stupor // Soporific Springs", "Chrome Mox", "Snuff Out"))
test_that("enabler 1 u + 2 lands where both produce colorless and mdfc u land and chrome mox on b", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Mutavault", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt", "Chrome Mox", "Force of Will"))
test_that("enabler 1 u + 2 lands where both produce colorless and mdfc b land and chrome mox on u", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Mutavault", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt", "Sink into Stupor // Soporific Springs"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Underground Sea", "Agadeem's Awakening // Agadeem, the Undercrypt"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Swamp", "Sink into Stupor // Soporific Springs"))
test_that("enabler 1 u + 1 land that produce b and mdfc u land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Swamp", "Mox Diamond", "Agadeem's Awakening // Agadeem, the Undercrypt"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Island", "Agadeem's Awakening // Agadeem, the Undercrypt"))
test_that("enabler 1 u + 1 land that produce u and mdfc b land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Island", "Mox Diamond", "Sink into Stupor // Soporific Springs"))
test_that("enabler 1 u + 1 land that produce u and mdfc u land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt", "Sink into Stupor // Soporific Springs"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Gemstone Caverns", "Mox Diamond", "Agadeem's Awakening // Agadeem, the Undercrypt"))
test_that("enabler 1 u + 1 land that produce colorless and mox diamond and any mdfc land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Gemstone Caverns", "Sink into Stupor // Soporific Springs", "Chrome Mox", "Snuff Out"))
test_that("enabler 1 u + 1 land that produce colorless and mdfc u land and chrome mox on b", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt", "Chrome Mox", "Force of Will"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Sink into Stupor // Soporific Springs", "Chrome Mox", "Snuff Out"))
test_that("enabler 1 u + no lands and mdfc u land and chrome mox on b", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Agadeem's Awakening // Agadeem, the Undercrypt", "Chrome Mox", "Force of Will"))
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Mutavault", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt", "Lotus Petal"))
test_that("no u t1", 
          {expect_false(is_yuriko_on_T2(hand))})
...
hand <- get_hand(testdata, c("Mothdust Changeling", "Lotus Petal", "Agadeem's Awakening // Agadeem, the Undercrypt"))
test_that("no u t1", 
          {expect_false(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Gemstone Caverns", "Agadeem's Awakening // Agadeem, the Undercrypt", "Lotus Petal"))
test_that("no u t1", 
          {expect_false(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Lotus Petal", "Agadeem's Awakening // Agadeem, the Undercrypt", "Swamp", "Takenuma, Abandoned Mire"))
test_that("no u t1", 
          {expect_false(is_yuriko_on_T2(hand))})

hand <- get_hand(testdata, c("Mothdust Changeling", "Agadeem's Awakening // Agadeem, the Undercrypt", "Sink into Stupor // Soporific Springs"))
