...
hand <- get_hand(decklist, c("Universal Automaton", "Island", "Otawara, Soaring City", "Mox Diamond"))
test_that("enabler 1 colorless + 2 lands that produce any color and mox diamond", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Otawara, Soaring City", "Lotus Petal"))
test_that("enabler 1 colorless + 2 lands that produce any color and lotus petal", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Swamp"))
test_that("enabler 1 colorless + 2 lands that produce ub", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Otawara, Soaring City", "Chrome Mox", "Snuff Out"))
test_that("enabler 1 colorless + 2 lands that produce u and chrome mox on b",
          { expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Otawara, Soaring City", "Agadeem's Awakening"))
test_that("enabler 1 colorless + 2 lands that produce u and mdfc b land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Takenuma, Abandoned Mire", "Chrome Mox", "Force of Will"))
test_that("enabler 1 colorless + 2 lands that produce b and chrome mox on u", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Takenuma, Abandoned Mire", "Sink into Stupor"))
test_that("enabler 1 colorless + 2 lands that produce b and mdfc u land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Gemstone Caverns", "Mox Diamond"))
test_that("enabler 1 colorless + 2 lands where only one produce color and mox diamond", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Gemstone Caverns", "Lotus Petal"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Island", "Gemstone Caverns", "Chrome Mox", "Snuff Out"))
test_that("enabler 1 colorless + 2 lands where one produce colorless and the other u and chrome mox on b", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Gemstone Caverns", "Agadeem's Awakening"))
test_that("enabler 1 colorless + 2 lands where one produce colorless and the other u and mdfc b land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Gemstone Caverns", "Chrome Mox", "Force of Will"))
test_that("enabler 1 colorless + 2 lands where one produce colorless and the other b and chrome mox on u", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Gemstone Caverns", "Sink into Stupor"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Mutavault", "Gemstone Caverns", "Sink into Stupor", "Mox Diamond"))
test_that("enabler 1 colorless + 2 lands where both produce colorless and mox diamond and mdfc land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Mutavault", "Gemstone Caverns", "Sink into Stupor", "Chrome Mox", "Snuff Out"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Mutavault", "Gemstone Caverns", "Agadeem's Awakening", "Sink into Stupor"))
test_that("enabler 1 colorless + 2 lands where both produce colorless and mdfc u land and mdfc b land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Lotus Petal"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Chrome Mox", "Force of Will"))
test_that("enabler 1 colorless + 1 land that produce b and chrome mox on u", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Sink into Stupor"))
test_that("enabler 1 colorless + 1 land that produce b and mdfc u land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Swamp", "Mox Diamond", "Agadeem's Awakening"))
test_that("enabler 1 colorless + 1 land that produce b and mdfc b land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Chrome Mox", "Snuff Out"))
test_that("enabler 1 colorless + 1 land that produce u and chrome mox on b", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Agadeem's Awakening"))
test_that("enabler 1 colorless + 1 land that produce u and mdfc b land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Island", "Mox Diamond", "Sink into Stupor"))
test_that("enabler 1 colorless + 1 land that produce u and mdfc u land", 
          {expect_true(is_yuriko_on_T2(hand))})

hand <- get_hand(decklist, c("Universal Automaton", "Gemstone Caverns", "Agadeem's Awakening", "Sink into Stupor"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Gemstone Caverns", "Sink into Stupor", "Chrome Mox", "Snuff Out"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Sink into Stupor", "Chrome Mox", "Snuff Out"))
...
hand <- get_hand(decklist, c("Universal Automaton", "Gemstone Caverns", "Sink into Stupor", "Chrome Mox", "Force of Will"))
